            ...
            <div className="sticky top-24 space-y-4">
              ...
              {(selectedCompanies.length > 0 ||
                ...
                <button
                  ...
                  className="w-full rounded-lg border border-white/10 bg-white/5 px-4 py-2 text-sm font-medium text-gray-300 transition-all hover:bg-white/10 hover:text-white"
                >
                  Clear all filters
                </button>
              )}
