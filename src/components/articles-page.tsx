              ...
              <div className="flex flex-wrap gap-3">
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <span className="hidden sm:inline">{getDateRangeLabel(dateRangeType)}</span>
                  </button>
                    ...
                    <>
                      ...
                      <div className="absolute right-0 top-full z-50 mt-2 w-64 rounded-xl border border-white/10 bg-[#0A0A0A] p-3 shadow-xl backdrop-blur-sm">
                        <div className="space-y-1">
                          {(["all", "today", "week", "month"] as DateRangeType[]).map((type) => (
                            <button
                              key={type}
                              type="button"
                              onClick={() => {
                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex-1 space-y-3">
                        ...
                        <div className="flex flex-wrap items-center gap-2 text-sm">
                          ...
                          {article.company.category.slice(0, 2).map((category) => (
                            <span
                              key={category}
